...
public class Material extends BusinessObject<Material> implements IMaterial {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = 1519287357232465421L;
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_ONORDER = registerProperty(PROPERTY_ONORDER_NAME, Decimal.class, MY_CLASS);
