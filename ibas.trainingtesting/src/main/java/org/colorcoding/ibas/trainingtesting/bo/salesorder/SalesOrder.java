...
public class SalesOrder extends BusinessObject<SalesOrder> implements ISalesOrder {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = 7302077393002724019L;
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_DOCNUM = registerProperty(PROPERTY_DOCNUM_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_PERIOD = registerProperty(PROPERTY_PERIOD_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_INSTANCE = registerProperty(PROPERTY_INSTANCE_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emYesNo> PROPERTY_HANDWRITTEN = registerProperty(PROPERTY_HANDWRITTEN_NAME, emYesNo.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emYesNo> PROPERTY_CANCELED = registerProperty(PROPERTY_CANCELED_NAME, emYesNo.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_USERSIGN = registerProperty(PROPERTY_USERSIGN_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emYesNo> PROPERTY_TRANSFERED = registerProperty(PROPERTY_TRANSFERED_NAME, emYesNo.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emBOStatus> PROPERTY_STATUS = registerProperty(PROPERTY_STATUS_NAME, emBOStatus.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emDocumentStatus> PROPERTY_DOCUMENTSTATUS = registerProperty(PROPERTY_DOCUMENTSTATUS_NAME, emDocumentStatus.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<DateTime> PROPERTY_POSTINGDATE = registerProperty(PROPERTY_POSTINGDATE_NAME, DateTime.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<DateTime> PROPERTY_DOCUMENTDATE = registerProperty(PROPERTY_DOCUMENTDATE_NAME, DateTime.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_CUSTOMERCODE = registerProperty(PROPERTY_CUSTOMERCODE_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_CUSTOMERNAME = registerProperty(PROPERTY_CUSTOMERNAME_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_DOCUMENTCURRENCY = registerProperty(PROPERTY_DOCUMENTCURRENCY_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_DOCUMENTRATE = registerProperty(PROPERTY_DOCUMENTRATE_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_DOCUMENTTOTAL = registerProperty(PROPERTY_DOCUMENTTOTAL_NAME, Decimal.class, MY_CLASS);
    ...
    * 周期 属性
    */
    @DbField(name = "Cycle", type = DbFieldType.DECIMAL, table = DB_TABLE_NAME, primaryKey = false)
    public static final IPropertyInfo<Decimal> PROPERTY_CYCLE = registerProperty(PROPERTY_CYCLE_NAME, Decimal.class, MY_CLASS);
    ...
    * @param value 值
    */
    public final void setCycle(Decimal value) {
    ...
    * @param value 值
    */
    public final void setCycle(String value) {
        this.setCycle(new Decimal(value));
    }
    ...
    * @param value 值
    */
    public final void setCycle(int value) {
        this.setCycle(new Decimal(value));
    }
    ...
    * @param value 值
    */
    public final void setCycle(double value) {
        this.setCycle(new Decimal(value));
    }
    ...
    * 周期单位 属性
    */
    @DbField(name = "CycleUnit", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
    public static final IPropertyInfo<String> PROPERTY_CYCLEUNIT = registerProperty(PROPERTY_CYCLEUNIT_NAME, String.class, MY_CLASS);
    ...
    * 
    */ 
    public static final IPropertyInfo<ISalesOrderItems> PROPERTY_SALESORDERITEMS = registerProperty(PROPERTY_SALESORDERITEMS_NAME, ISalesOrderItems.class, MY_CLASS);
    /**
    * 获取-销售订单-行集合
    * 
    * @return 值
