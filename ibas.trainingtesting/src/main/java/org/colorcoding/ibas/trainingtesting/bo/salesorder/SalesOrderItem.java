...
@XmlType(name = SalesOrderItem.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
public class SalesOrderItem extends BusinessObject<SalesOrderItem> implements ISalesOrderItem {

    /**
     * 序列化版本标记
     */
    private static final long serialVersionUID = -6401745298543654076L;
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_VISORDER = registerProperty(PROPERTY_VISORDER_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<emDocumentStatus> PROPERTY_LINESTATUS = registerProperty(PROPERTY_LINESTATUS_NAME, emDocumentStatus.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_QUANTITY = registerProperty(PROPERTY_QUANTITY_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_OPENQUANTITY = registerProperty(PROPERTY_OPENQUANTITY_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_PRICE = registerProperty(PROPERTY_PRICE_NAME, Decimal.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_PRICECURRENCY = registerProperty(PROPERTY_PRICECURRENCY_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Decimal> PROPERTY_LINETOTAL = registerProperty(PROPERTY_LINETOTAL_NAME, Decimal.class, MY_CLASS);
